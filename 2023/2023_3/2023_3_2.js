...
var possibleGears = possibleGearsOverall.reduce((group, possibleGear) => {
  var { rowIndex, colIndex, partNumber } = possibleGear;
...
var gearRatioSum = Object.keys(possibleGears)
